...
//         <div>
//           <ControlLabel htmlFor="email">Your Email</ControlLabel>
//           <FormControl id="email" type="email" placeholder="johndoe@mail.com" name="signUpEmail" onChange={this.handleChange} value={this.props.value}/>
//         </div>
//         <div>
//           <ControlLabel htmlFor="password">Password</ControlLabel>
//           <FormControl id="password" type="password" placeholder="qweqweqwe" name="signUpPassword" onChange={this.handleChange} value={this.props.value}/>
//         </div>
//         <div>
