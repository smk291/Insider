    ...
    return(
      <div>
        ...
        <div style={{textAlign: 'left', float: 'left', bottom: '0px'}}>
          <div style={{margin: '20px'}} onClick={this.saveToFavorites(el.id)} ><Button bsStyle='primary'>Save this listing to your account <MdSave style={{}} width="24" fill="hsl(200, 50%, 50%)" height="24"/></Button></div>
        </div>
